...
namespace LIS.v10.Areas.HIS10.Controllers
{
    public class HisInchargesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,Remarks,AccntUserId,ContactInfo")] HisIncharge hisIncharge)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,Remarks,AccntUserId,ContactInfo")] HisIncharge hisIncharge)
        {
            if (ModelState.IsValid)
            {
